...
Before the conference (either version): do a full dry run ~2 weeks out and again the day before; update the placeholder notebook link (open-source version, slide 11 + handout + email).
